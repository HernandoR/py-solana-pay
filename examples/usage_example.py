...
class SolanaPayClient:
    ...
    def register_user(self, username: str, email: str, fullname: str, password: str, wallet_key: str = None) -> Dict[str, Any]:
        """Register a new user"""
        data = {
            "username": username,
            "email": email,
    ...
    def create_product(self, name: str, price: float, quantity: int = 1, image: str = None) -> Dict[str, Any]:
    ...
    def generate_payment_url(self, recipient: str, amount: float, label: str = None, message: str = None) -> Dict[str, Any]:

...
def main():
    ...
    url_parser = subparsers.add_parser("generate-url", help="Generate Solana payment URL")
    url_parser.add_argument("--recipient", required=True, help="Recipient wallet address")
    url_parser.add_argument("--amount", type=float, required=True, help="Payment amount in SOL")
    ...
    verify_parser.add_argument("--signature", required=True, help="Transaction signature")
    verify_parser.add_argument("--expected-recipient", help="Expected recipient address")
